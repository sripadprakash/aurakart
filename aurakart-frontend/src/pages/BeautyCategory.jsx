...
import { FiArrowLeft, FiHeart, FiStar, FiZap, FiTarget, FiActivity } from 'react-icons/fi';

const BeautyCategory = () => {
  const beautyProducts = products.filter(p => p.categoryId === 5);
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                  Aura <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-purple-500">Beauty</span>
                </h1>
              </div>
              <p className="text-gray-400 text-lg max-w-xl font-medium">
                Experience the convergence of biotechnology and luxury self-care. Redefining the standard of clinical excellence.
              </p>
            </motion.div>
          </div>
