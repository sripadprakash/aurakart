...
import { FiArrowLeft, FiStar, FiShield, FiTruck, FiHeart, FiZap, FiX, FiCheckCircle, FiCpu, FiSmartphone, FiBattery, FiCamera, FiWifi, FiActivity, FiHardDrive, FiMapPin, FiSlash, FiLayout } from 'react-icons/fi';
...
const AuraLiteSE = () => {
  ...
  const specs = [
    { label: "Processor", value: "Aura G85 Efficiency", icon: <FiCpu className="text-orange-400" /> },
    { label: "Memory", value: "8GB RAM, 128GB", icon: <FiHardDrive className="text-blue-400" /> },
    { label: "Display", value: "6.5\" LCD 90Hz", icon: <FiLayout className="text-purple-400" /> },
    { label: "Battery", value: "5000 mAh", icon: <FaBatteryFull className="text-green-400" /> },
    { label: "Network", value: "4G LTE Enhanced", icon: <FiWifi className="text-cyan-400" /> },
    { label: "Warranty", value: "1 Year Standard", icon: <FiShield className="text-red-400" /> },
  ];
        ...
        <main className="flex-grow pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="relative group">
              ...
              <img src={product.image} alt="Lite SE" className="relative rounded-2xl shadow-2xl border border-white/10 w-full object-cover aspect-square grayscale-[0.5]" />
            </motion.div>

            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="flex flex-col gap-6">
              <div>
                <span className="bg-red-500/20 text-red-400 px-4 py-1.5 rounded-md text-xs font-bold tracking-widest uppercase mb-4 inline-block border border-red-500/30">8GB RAM, 128GB Edition</span>
                <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-4 text-gray-400 text-left leading-tight">Aura <br /><span className="text-white/50">Lite SE (8GB RAM, 128GB)</span></h1>
              ...
              <p className="text-xl text-gray-300 leading-relaxed font-medium text-left">Powerful features in a compact, affordable package. The Aura Lite SE (8GB RAM, 128GB) is perfect for everyday essentials, delivering reliable performance and a stunning display.</p>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="flex items-center gap-3 p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md opacity-50">
                  ...
                  <span className="text-sm font-bold text-gray-400">1 Year Standard</span>
                </div>
                <div className="flex items-center gap-3 p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md opacity-50">
