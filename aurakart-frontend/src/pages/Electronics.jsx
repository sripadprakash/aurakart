...
import { FiArrowLeft, FiMonitor, FiCpu, FiCamera, FiZap, FiWifi } from 'react-icons/fi';

const Electronics = () => {
  const electronicsProducts = products.filter(p => p.categoryId === 3);
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-blue-500/20 p-3 rounded-2xl border border-blue-500/20 text-blue-500">
                  <FiMonitor size={32} />
                </div>
                <h1 className="text-5xl md:text-7xl font-black tracking-tighter">
                  Aura <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-500">Electronics</span>
                </h1>
              </div>
              <p className="text-gray-400 text-lg max-w-xl font-medium">
                Pushing the boundaries of what's possible with cutting-edge tech and next-gen hardware.
              </p>
            </motion.div>
          </div>
