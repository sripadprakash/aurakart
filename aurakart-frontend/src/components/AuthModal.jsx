            ...
            {user ? (
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/5">
                  <h2 className="text-xl font-black text-white uppercase tracking-widest">Account</h2>
                  <button 
              ...
              <div className="flex flex-col h-full">
                {/* Header for Forms */}
                <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/5">
                  <h2 className="text-xl font-black text-white uppercase tracking-widest">{isLoginTab ? 'Login' : 'Join'}</h2>
                  <button 
                    onClick={() => setIsAuthModalOpen(false)} 
                    className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 active:scale-95 transition-all text-white border border-white/5"
                  >
